  ...
  results: [
    {
      ...
      overview: `즌 11에 가까우며 본작의 시간대는 마지막 정규 에피소드 'Come Along With Me'로 부터 10여년이 지난 후이다.
      그 외 특징으로 본편에서도 비중 있게 다루었던 다중 우주를 다루며, 사이먼과 피오나와 케이크 일행이 존재를 없애기로 결심한 미지의 적 '스캐럽'에 맞서 여행을 하게 된다.
      TV-PG 등급이였던 본편과 달리 Max에서 TV-14로 방영하는 성인 애니메이션으로 바뀐 만큼, 전체적인 수위가 상당히 높아졌다.`,
      popularity: 244.518,
